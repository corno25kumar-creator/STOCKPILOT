Bahut acha question 👌
Ab tum architecture samajhne wali stage pe ho 💪

Main simple language me explain karta hoon — **ye kya hai aur kyun use kiya hai**.
...
Socho GraphQL ek receptionist hai.
...
# 🔥 Modular System Kyun Banaya?

Agar sab kuch ek file me likhte:

* 1000+ lines
* Maintain karna mushkil
* Internship me reject pattern
...
Abhi:
Resolver → static array return kar raha

Future:
Resolver → Mongoose Model → MongoDB

Architecture change nahi hoga
Bas data source change hoga

Ye hi clean architecture hai 🔥

---

Agar chaho toh next me:

* Real DB connect karte hain
* Mutation add karte hain
* Ya diagram ka technical breakdown karein

Tum kis direction me jana chahte ho 😎
